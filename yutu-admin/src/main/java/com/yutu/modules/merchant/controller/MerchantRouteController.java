...
public class MerchantRouteController {
    ...
    public Result<List<ContractTemplate>> contractTemplates(@RequestParam(required = false) Long categoryId) {
        return Result.ok(merchantService.availableContractTemplates(categoryId));
    }
