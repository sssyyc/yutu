...
public class AdminMerchantController {
    ...
    public Result<AdminMerchantRecordVO> records(@PathVariable Long id) {
        return Result.ok(adminService.merchantRecords(id));
    }
    ...
    public Result<Void> warn(@PathVariable Long id,
                             @RequestBody(required = false) MerchantAuditRequest request) {
        adminService.merchantWarn(id, request);
        return Result.ok();
    }
    ...
    public Result<Void> ban(@PathVariable Long id,
                            @RequestBody(required = false) MerchantAuditRequest request) {
        adminService.merchantBan(id, true, request);
        return Result.ok();
    }
    ...
    public Result<Void> unban(@PathVariable Long id,
                              @RequestBody(required = false) MerchantAuditRequest request) {
        adminService.merchantBan(id, false, request);
        return Result.ok();
    }
}
