        ...
        <el-row :gutter="14">
          <el-col :span="12" v-for="item in hotRoutes.slice(0, 6)" :key="`hot-${item.id}`">
            <div class="route-item">
              <button type="button" class="route-cover route-cover-button" @click="openRoute(item.id)">
              ...
              <div class="route-body">
                ...
                <div class="route-footer">
                  ...
                  <el-button text type="primary" @click="openRoute(item.id)">
                    {{ TEXT.viewDetail }}
                  </el-button>
                </div>
              </div>
          ...
          <el-col :span="12" v-for="item in recommendRoutes.slice(0, 6)" :key="`rec-${item.id}`">
            <div class="route-item">
              ...
              <div class="route-body">
                ...
                <div class="route-footer">
                  <span class="route-price">{{ `${TEXT.yuan}${formatPrice(item.price)}` }}</span>
                  <el-button text type="success" @click="openRoute(item.id)">
                    {{ TEXT.viewNow }}
                  </el-button>
                </div>
              </div>
