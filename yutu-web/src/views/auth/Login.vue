    ...
    <section class="auth-shell">
      ...
      <section class="auth-panel">
        ...
        <el-form :model="form" class="auth-form" label-position="top" @submit.prevent>
          ...
          <el-button class="submit-btn" type="primary" size="large" @click="submit">登录系统</el-button>
          <el-button class="switch-btn" text @click="$router.push('/register')">没有账号？去注册</el-button>
        </el-form>
      </section>
    </section>
  </div>
