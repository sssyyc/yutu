...
const STANDARD_TEMPLATE_CONTENT = `旅游团队标准合同（国家制式示意）

合同编号：_____________
甲方（旅游者）：_____________
乙方（旅行社）：_____________

一、旅游产品及服务内容
1. 旅游线路：_____________
2. 出发日期：_____________
3. 结束日期：_____________
4. 服务标准：交通、住宿、餐饮、导游服务等按国家制式合同执行。

二、费用与支付方式
1. 合同总金额：_____________
2. 支付方式：_____________

三、双方权利义务
旅游者和旅行社双方应按国家旅游合同示范文本约定履行权利义务。
...
function preview(row) {
  previewTemplate.value = {
    ...enrichTemplate(row),
    previewContent: STANDARD_TEMPLATE_CONTENT
  };
...
补充主题：${form.supplementTheme || "-"}
适用场景：${form.supplementScenario || "-"}
